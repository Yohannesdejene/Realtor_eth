...
const images = [
  {
    url: "/Realestates/noah/4.png",
    title: "Image 3",
    description: "Noah Realestate Homes in construction",
  },
  {
    url: "/Realestates/noah/5.png",
    title: "Image 3",
    description: "Noah to Deliver Houses for Second Time in Year",
  },
];

const NoahRealestate = () => {
  ...
  useEffect(() => {
    ...
    const fetchFilter = () => {
      try {
        api
          .get(
            `/unauth/house/filterrealestate?offset=${currentPage}&realestateType=noah&bedrooms=${filter.bedrooms}&bathrooms=${filter.bathrooms}&minPrice=${filter.minPrice}&maxPrice=${filter.maxPrice}&minArea=${filter.minArea}&maxArea=${filter.maxArea}&subcity=${filter.subcity}&furnishingType=${filter.furnishingType}&serviceType=${filter.serviceType}`,
            {
  ...
  return (
    <>
      ...
      <Box sx={{ ml: "5%", mr: "5%", mb: "20px" }}>
        <CommonTypography label=" Noah Realestates" />
