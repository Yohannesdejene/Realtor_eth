...
const images = [
  {
    url: "/Realestates/phison/1.png",
    title: "Image 1",
    description: "Phison Realetstate  appartments home compound",
  },

  {
    url: "/Realestates/phison/2.png",
    title: "Image 3",
    description: "",
  },
];

const PhisonRealestate = () => {
  ...
  useEffect(() => {
    ...
    const fetchFilter = () => {
      try {
        api
          .get(
            `/unauth/house/filterrealestate?offset=${currentPage}&realestateType=phison&bedrooms=${filter.bedrooms}&bathrooms=${filter.bathrooms}&minPrice=${filter.minPrice}&maxPrice=${filter.maxPrice}&minArea=${filter.minArea}&maxArea=${filter.maxArea}&subcity=${filter.subcity}&furnishingType=${filter.furnishingType}&serviceType=${filter.serviceType}`,
            {
  ...
  return (
    <>
      ...
      <Box sx={{ ml: "5%", mr: "5%", mb: "20px" }}>
        <CommonTypography label=" Phison Realestates" />
...
export default PhisonRealestate;
